...
namespace ControleFacil.Api.Controllers
{
    ...
    public class UsuarioController :  BaseController
    {
        ...
        public async  Task<ActionResult> Autenticar(UsuarioLoginRequestContract contrato) {
            try {
        ...
        public async  Task<ActionResult> Adicionar(UsuarioRequestContract contrato) {
            try {
        ...
        public async  Task<ActionResult> Atualizar(long id, UsuarioRequestContract contrato) {
            try {
